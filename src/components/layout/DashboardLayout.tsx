...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="relative h-dvh overflow-hidden bg-white">
    <SkipLink />
    <header className="pointer-events-none fixed inset-x-3 top-[max(.75rem,env(safe-area-inset-top))] z-[100] sm:inset-x-5">
      <div className="pointer-events-auto relative mx-auto flex h-16 max-w-[90rem] items-center justify-between rounded-xl border border-white/80 bg-white/95 px-3 shadow-[0_14px_40px_rgba(20,41,34,.15)] backdrop-blur-xl sm:px-4">
