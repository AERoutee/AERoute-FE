...
function recommendationLabel(route: RouteOption) {
  return route.labels.includes('FASTEST') && route.labels.includes('LOWEST_EXPOSURE') ? 'Best overall' : 'PM2.5/time trade-off'
}
