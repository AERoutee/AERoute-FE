...
type MapLayerControlProps = { layers: MapLayers; weatherUnavailable: boolean; disabled?: boolean; onChange: (layers: MapLayers) => void }

export function MapLayerControl({ layers, weatherUnavailable, disabled = false, onChange }: MapLayerControlProps) {
